...
function homePage(req, res, formData) {
  ...
  readFile("./html/home.html", function (err, content) {
    if (err) {
...
function loginPage(req, res) {
  ...
  readFile("./html/login.html", function (err, content) {
    if (err) {
    ...
    if (req.headers.cookie) {
      ...
      // console.log(name[1]);
      const greeting =
        "Welcome back " + name[1] + ", please enter your password.";
...
function pageNotFound(res) {
  ...
  readFile("./html/pageNotFound.html", function (err, content) {
    if (err) {
